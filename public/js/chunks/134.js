...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  createCustomer: function createCustomer(_ref, customer) {
    ...
    alert("clicked");
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/customers/", {
        customer: customer
  ...
  fetchUser: function fetchUser(_ref3, userId) {
    ...
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/customers/".concat(userId)).then(function (response) {
        resolve(response);
      })["catch"](function (error) {
        reject(error);
      });
  ...
  removeRecord: function removeRecord(_ref4, userId) {
    ...
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("/api/user-management/users/".concat(userId)).then(function (response) {
