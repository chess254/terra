        ...
        // =============================================================================
                ...
                */
                ...
                },
                {
                    ...
                    component: () => import('@/views/apps/user/user-create/UserCreate.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'User' },
                ...
                {
                    path: '/apps/transaction/transaction-list',
                    name: 'app-transaction-list',
                    component: () => import('@/views/apps/transaction/transaction-list/TransactionList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Customers' },
                ...
                {
                    path: '/apps/transaction/transaction-view/:transactionId',
                    name: 'app-transaction-view',
                    component: () => import('@/views/apps/transaction/TransactionView.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Transaction' },
                ...
                {
                    path: '/apps/transaction/transaction-edit/:transactionId',
                    name: 'app-transaction-edit',
                    component: () => import('@/views/apps/transaction/transaction-edit/TransactionEdit.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Transaction' },
                ...
                {
                    path: '/apps/transaction/transaction-create',
                    name: 'app-transaction-create',
                    component: () => import('@/views/apps/transaction/transaction-create/TransactionCreate.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'Transaction' },
